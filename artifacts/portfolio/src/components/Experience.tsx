...
export default function Experience({ data: dataProp, visible: visibleProp }: ExperienceProps = {}) {
  ...
  return (
    <section id="experience" className="relative py-10 md:py-16">
            ...
            {timeline.map((entry, i) => (
              ...
              >
                <div
                  ...
                  style={{ background: entry.color || "#f97316", boxShadow: `0 0 10px ${entry.color || "#f97316"}50` }}
                >
                ...
                <div
                  ...
                  style={{ color: entry.color || "#f97316", background: (entry.color || "#f97316") + "15", border: `1px solid ${entry.color || "#f97316"}30` }}
                >
                  {entry.year}
                </div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {entry.tags.map((tag) => (
                      <span
                        ...
                        style={{ background: (entry.color || "#f97316") + "15", color: entry.color || "#f97316", border: `1px solid ${entry.color || "#f97316"}30` }}
                      >
                        {tag}
                      </span>
                    ))}
