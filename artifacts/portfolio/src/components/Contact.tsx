        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            <div className="glass rounded-2xl p-6 border border-border/50 h-full">
              ...
              <p className="text-sm text-muted-foreground mb-6 leading-relaxed">{bio}</p>
              ...
              <div>
                <div className="text-xs font-semibold text-muted-foreground uppercase tracking-widest mb-3">Find Me Online</div>
                  ...
                  {socials.map((s, i) => {
                    ...
                    return (
                      <motion.a
                        ...
                        className="flex items-center gap-2 px-3 py-2 rounded-xl glass border border-border/50 hover:border-primary/30 transition-all group"
                      >
                        <IconComponent className="w-3.5 h-3.5 text-muted-foreground group-hover:text-primary transition-colors shrink-0" />
                        <span className="text-xs text-muted-foreground group-hover:text-foreground transition-colors">{s.label}</span>
                        <ExternalLink className="w-2.5 h-2.5 ml-auto opacity-0 group-hover:opacity-100 text-primary transition-opacity" />
                      </motion.a>
                    );
                  })}
                </div>
          ...
          >
            <form onSubmit={handleSubmit} className="glass rounded-2xl p-5 border border-border/50 space-y-3">
              <div>
                <label className="text-xs font-semibold text-foreground block mb-1.5">Your Name</label>
                <input
                  type="text"
                  required
                  value={formData.name}
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-muted/50 border border-border text-foreground placeholder:text-muted-foreground text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/50 transition-all disabled:opacity-60"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  disabled={status === "sending"}
                  className="w-full px-3 py-2 rounded-xl bg-muted/50 border border-border text-foreground placeholder:text-muted-foreground text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/50 transition-all resize-none disabled:opacity-60"
                />
              </div>
              ...
              <motion.button
                ...
                className="w-full flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-white font-bold text-sm neon-glow hover:bg-primary/90 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {status === "sending" && (
